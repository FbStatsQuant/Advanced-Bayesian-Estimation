...
mse_3_sp <- mean((test_data$y - as.numeric(predictions))^2)
print(paste("Mean Squared Error (MSE):", mse_3_sp))
...
mse_3_gp <- mean((test_data$y - predictions)^2)
print(paste("Mean Squared Error (MSE):", mse_3_gp))
