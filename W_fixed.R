...
ggplot(data, aes(x=x)) +
  geom_point(aes(y=y), color = "black", size = 1, alpha = 1) +
...
ggplot(data, aes(x = x)) +
  ...
  labs(
    ...
    x = "x",
    y = "Value",
    caption = "Light Blue: True Function | Black: Horseshoe Prior | Blue: Ridge Regression"
  ) +
  scale_color_manual(values = c("True Function" = "lightblue", 
                                "Horseshoe Prior" = "black", 
